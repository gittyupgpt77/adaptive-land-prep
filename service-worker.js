...
const ASSETS=['./','./index.html','./styles.css?v=70','./app.js?v=70','./training-tools.js?v=70','./manifest.webmanifest','./vendor/supabase.js','./cloud-core.js','./autosave-core.js','./cloud.js?v=70','./vendor/firebase.js','./firestore-backup.js'];

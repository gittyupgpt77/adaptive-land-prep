const CACHE='land-prep-v66';
const ASSETS=['./','./index.html','./styles.css?v=66','./app.js?v=66','./manifest.webmanifest','./vendor/supabase.js','./cloud-core.js','./autosave-core.js','./cloud.js?v=66','./vendor/firebase.js','./firestore-backup.js'];

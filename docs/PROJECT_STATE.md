...
Next: dedicated Settings reusing account/backup controls and persistent Day 1 fix. Restart needs an archived Journey epoch with atomic rollback and backup support; changing programStart alone would contaminate qualification and date-based records.

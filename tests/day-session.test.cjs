...
test('reopening a morning draft resumes it without repeating Hello',()=>{const h=harness({...open,greetingSeen:true},false);h.context.resumeDaySession(new Date('2026-09-07T13:00:00Z'));assert.equal(h.context.greetOnThisOpening,false)});

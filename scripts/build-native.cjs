...
for (const name of ['index.html', 'styles.css', 'app.js', 'training-tools.js', 'firestore-backup.js', 'cloud-core.js', 'autosave-core.js', 'cloud.js', 'vendor', 'assets', 'manifest.webmanifest']) {
